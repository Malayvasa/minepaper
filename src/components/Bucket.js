...
export default function Bucket({backgroundColor}) {
  return (
    <div>
        <div>
                <svg
                ...
                >
                  <g clip-path="url(#clip0_1_56)">
                    ...
                    />
                    <path
                      d="M109.54 99.58V119.46H99.6V99.58H109.54Z"
                      fill="#353535"
                    />
                    <path
                      d="M20.09 119.45H10.15V99.57H20.09V119.45Z"
                      fill="#353535"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M10.16 20.07V10.13H30.04V20.07H10.16Z"
                      fill="#353535"
                    />
                    <path
                      d="M30.03 129.39H20.09V119.45H30.03V129.39Z"
                      fill="#353535"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M99.6 89.64V69.76H109.54V89.64H99.6Z"
                      fill="#A8A8A8"
                    />
                    <path
                      d="M109.54 69.76H99.6V49.88H109.54V69.76Z"
                      fill="#969696"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M99.6 89.64H109.54V99.58H99.6V89.64Z"
                      fill="#969696"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M10.16 20.07H20.1V30.01H10.16V20.07V20.07Z"
                      fill="#787878"
                    />
                    <path
                      d="M30.03 59.83H20.09V49.89H30.03V59.83Z"
                      fill="#A8A8A8"
                    />
                    <path
                      d="M10.16 79.7H20.1V89.64H10.16V79.7V79.7Z"
                      fill="#A8A8A8"
                    />
                    <path
                      d="M10.16 89.64H20.1V99.58H10.16V89.64V89.64Z"
                      fill="#727272"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M69.78 129.39V119.45H79.72V129.39H69.78Z"
                      fill="#727272"
                    />
                    <path
                      d="M79.72 129.39V119.45H89.66V129.39H79.72Z"
                      fill="#969696"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M89.66 119.45V99.57H99.6V119.45H89.66Z"
                      fill="#969696"
                    />
                    <path
